...
Uso:
    ...
    python data_pipeline/build_dataset.py --ticker AAPL   # solo un ticker
"""
import sys
import logging
...
from shared.config.settings import DB_PATH, ALL_TICKERS
...
OUTPUT_PATH = Path(__file__).resolve().parents[1] / "data" / "processed" / "dataset.parquet"
