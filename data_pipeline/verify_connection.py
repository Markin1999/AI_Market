...
Esegui dopo aver inserito la API key in shared/config/.env
"""
import sys
...
from shared.config.settings import POLYGON_API_KEY, ALL_TICKERS, TICKERS_BY_SECTOR
import requests
...
def check_api_key():
    if not POLYGON_API_KEY or POLYGON_API_KEY == "inserisci_qui_la_tua_key":
        ...
        print("  → Apri shared/config/.env e inserisci la tua POLYGON_API_KEY")
        return False
...
if __name__ == "__main__":
    ...
    print("  python data_pipeline/download_history.py")
