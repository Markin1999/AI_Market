...
# shared/config/settings.py → parents[2] = root del progetto
ROOT_DIR = Path(__file__).resolve().parents[2]
# .env sta accanto a questo file, dentro shared/config/
...
PARQUET_PATH = ROOT_DIR / "data" / "processed" / "dataset.parquet"
